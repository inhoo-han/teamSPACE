                            ...
                            <div id="polygon3">
                                <div id="polygon2">
                                    <div id="polygon_text">
                                        ...
                                        <p class="result_contents">오답입니다😢</p>
                                        <button class="gotoInner_btn uquiz_btn" type="submit" onclick="location.href='${contextPath}/uquiz/uquiz-inner.jsp';"><span>다시 풀어보기</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
