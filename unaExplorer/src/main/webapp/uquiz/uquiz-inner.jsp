...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/uquiz-inner.css">
    ...
    <script src="${contextPath}/resources/js/uquiz.js"></script>
</head>
<body>
    <!-------------------- [S] #wrap -------------------->
    <div id="wrap">
                            ...
                            <div id="polygon3">
                                <div id="polygon2">
                                    <div id="polygon_text">
                                        ...
                                        <p class="q">Q</p>
                                        <p class="question">봄철 밤하늘을 올려다보면<br>
                                            아주 커다란 국자를 하나 볼 수 있어요.<br><br>
                                            
                                            이 국자의 이름 바로 ‘북두칠성’이랍니다.<br>
                                            그럼 북두칠성은 어떤 별자리 안에<br>
                                            포함되어 있을까요?</p>
                                        <input class="answer" type="text" placeholder="정답 4글자">
                                        <button class="submit_btn uquiz_btn" type="submit"><span>정답 제출</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
