...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/uquiz-index.css">
                            ...
                            <div id="polygon3">
                                <div id="polygon2">
                                    <div id="polygon1">
                                        ...
                                        <div id="uquiz_start_area" onclick="location.href='${contextPath}/uquiz/uquiz-inner.jsp'">
                                            <p class="uquiz_start_btn">
                                                퀴즈 풀러가기
                                            </p>
                                        </div>
                                    </div>
