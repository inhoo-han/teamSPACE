    ...
    <div id="wrap">
        ...
        <div id="container">
            ...
            <div id="polygon_area">
                ...
                <div id="poly_main" class="polygon_border">
                    ...
                    <div class="polygon">
                        ...
                        <div class="umbti_area">
                            ...
                            <img src="${contextPath}/resources/images/umbti_result/star_horse.png" alt="페가수스이미지">
                        </div>
                    </div>
                </div>
                <div class="result_detail">
                	<div class="result_detail_text">
                		<p>새로운 환경이나 상황에 잘 적응하는 페가수스 자리!</p>
                		<p>친화력 갑, 최강 인싸라고 할 수 있어요. 재밌고 매력적이라는 말을 귀가 아플 정도로 들어요.</p>
                		<p>깊게 생각하는 것을 아주아주 싫어해요.</p>
                		<p>나 이외의 다른 사람들에게는 관심이 없어서 자기애가 넘쳐요. 돌려 말하는 것을 굉장히 싫어합니다.</p>
                	</div>
                </div>
                <!-- 나와 잘 맞는 육각형 영역 테두리 -->
                <div id="poly_good" class="sub_polygon_border" onclick="location.href='${contextPath}/umbtimap/result.una'">
                    <!-- 서브 육각형 영역 내부 -->
                ...
                <!-- 나와 안 맞는 육각형 영역 테두리 -->
                <div id="poly_bad" class="sub_polygon_border" onclick="location.href='${contextPath}/umbtimap/result2.una'">
                    <!-- 서브 육각형 영역 내부 -->
                    <div class="sub_polygon">
                        <!-- 서브 결과 출력 영역 -->
                        <div class="umbti_area">
