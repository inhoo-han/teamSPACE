...
function clickCard(num) {
    ...
    switch(num) {
        case 0 : image = "url("+ getContextPath() +"/ucard/images/cards/card0.png)"; break;
        case 1 : image = "url("+ getContextPath() +"/ucard/images/cards/card1.png)"; break;
        case 2 : image = "url("+ getContextPath() +"/ucard/images/cards/card2.png)"; break;
        case 3 : image = "url("+ getContextPath() +"/ucard/images/cards/card3.png)"; break;
        case 4 : image = "url("+ getContextPath() +"/ucard/images/cards/card4.png)"; break;
        case 5 : image = "url("+ getContextPath() +"/ucard/images/cards/card5.png)"; break;
        case 6 : image = "url("+ getContextPath() +"/ucard/images/cards/card6.png)"; break;
        case 7 : image = "url("+ getContextPath() +"/ucard/images/cards/card7.png)"; break;
        case 8 : image = "url("+ getContextPath() +"/ucard/images/cards/card8.png)"; break;
        case 9 : image = "url("+ getContextPath() +"/ucard/images/cards/card9.png)"; break;
