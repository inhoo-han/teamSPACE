...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/ucard/css/ucard-gamestart.css">
    ...
    <script src="${contextPath}/ucard/js/ucard-gamestart.js"></script>
</head>
<body>
    <!-------------------- [S] #wrap -------------------->
    <div id="wrap">
        ...
        <!-- 배경에 육각형을 넣어보고 싶어졌다. -->
            ...
            <div id="ucard_area">
                    ...
                    <div class="side left">
                        ...
                        <div id="game_over" style="z-index: -1;">
                            ...
                            <div>
	                            ...
	                            <form id="fm_score" action="${contextPath}/ucardmap/ucardRanking.una" method="get" >
	                            	<input type="hidden" name="ucard_recent" >
	                            	<input class="submit_rank_btn" type="submit" value="랭킹 등록하기">
	                            </form>
	                        </div>
                            </c:if>
                            <c:if test="${isLogon == false || log_id == null}">
                            	<span>회원 등록하시면 점수를 랭킹에 등록하실 수 있습니다!</span>
                            	<p onclick="location.href='${contextPath}/member/loginForm.do'">로그인 하러가기</p>
                            </c:if>
                        </div>
                    </div>
                    &nbsp;&nbsp;
                ...
                <div id="mask"></div>
                <!-- 하단 육각형 게임 로고 영역 -->
                <div id="polygon_area" onclick="location.href='${contextPath}/ucard/ucard-index.jsp'">
