        ...
        if(number != "") {
            if(clicked.length == 0) {
                ...
                if(!chk) {	
                    ...
                    $('#fm_score input[name=ucard_recent]').val(setCount);
...
function clickCard(num) {
    ...
    switch(num) {
        case 0 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card0.png)"; break;
        case 1 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card1.png)"; break;
        case 2 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card2.png)"; break;
        case 3 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card3.png)"; break;
        case 4 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card4.png)"; break;
        case 5 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card5.png)"; break;
        case 6 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card6.png)"; break;
        case 7 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card7.png)"; break;
        case 8 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card8.png)"; break;
        case 9 : image = "url("+ getContextPath() +"/resources/images/ucard_cards/card9.png)"; break;
    }
    return image;
}
